...
exports.FrenchSentimentAnalyzer = void 0;
...
var FrenchSentimentAnalyzer = /** @class */ (function () {
    function FrenchSentimentAnalyzer() {
    }
    FrenchSentimentAnalyzer.getSentiment = function (sentence) {
        if (!sentence.trim()) {
    ...
    return FrenchSentimentAnalyzer;
}());
exports.FrenchSentimentAnalyzer = FrenchSentimentAnalyzer;
